...
const ContactUsForm = () => {
  ...
  const submitContactForm = async (data) => {
    ...
    try {
      setLoading(true)
      const res = await apiConnector("POST", contactusEndpoint.CONTACT_US_API, data)  //calling the api to connect with B.E
  ...
  //agr form submit ho gya successfully to data reset krdo
  useEffect(() => {
      ...
      <div className="flex flex-col gap-5 lg:flex-row">
        ...
        <div className="flex flex-col gap-2 lg:w-[48%]">
          ...
          <input
            ...
            {...register("firstname", { required: true })}  //first name ko resgiter kr rhe h
          />
          {
            errors.firstname && (               //first name se related agr error aata h to
          ...
          <div className="flex w-[calc(100%-90px)] flex-col gap-2">
            <input
              ...
              {...register("phoneNo", {
                required: {
                  value: true,
                  message: "Please enter your Phone Number.",  //agr required true nhi h to ye msg show ho hovga
                },
